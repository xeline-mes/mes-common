package com.xeline.core.util.http;

import static com.xeline.core.constant.Character.BLANK;
import static com.xeline.core.constant.Encoding.UTF8;
...
public class HttpClientUtil {
  ...
  public static String executeMultipartPost(String postUrl, Map<String, Object> params, String accessTokens) throws Exception {
    try {
      HttpClient httpClient = getThreadSafeClient();
      ...
      postRequest.setHeader("Authorization", "OAuth oauth_token=" + accessTokens
          + ", oauth_consumer_key=a324957217164fd1d76b4b60d037abec, oauth_version=1.0, oauth_signature_method=HMAC-SHA1, oauth_timestamp=1322049404, oauth_nonce=-5195915877644743836, oauth_signature=wggOr1ia7juVbG%2FZ2ydImmiC%2Ft4%3D");
  ...
  public static String executeGet(final URL url, boolean safeThread) {
    ...
    try {
      ...
      // httpget.setHeader("Authorization", "OAuth oauth_token=223a363ea1fd0a13b44e52663b97a255, oauth_consumer_key=a324957217164fd1d76b4b60d037abec, oauth_version=1.0,
      // oauth_signature_method=HMAC-SHA1, oauth_timestamp=1322049404, oauth_nonce=-5195915877644743836, oauth_signature=wggOr1ia7juVbG%2FZ2ydImmiC%2Ft4%3D");
  ...
  public static String executeGet(String baseUrl, Map<String, Object> params) {
    ...
    try {
      for (String p : ps) {
        String v = URLEncoder.encode(params.get(p).toString().trim(), UTF8);
        if (!v.equals(BLANK)) {
          p = URLEncoder.encode(p, UTF8);
