...
public @interface NumberString {
  ...
  String message() default "{com.xeline.annotation.validation.constraints.NumberString.message}";
  ...
  /**
   * Defines several {@code @NumberString} annotations on the same element.
   */
  @Target({METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER})
  @Retention(RUNTIME)
  @Documented
