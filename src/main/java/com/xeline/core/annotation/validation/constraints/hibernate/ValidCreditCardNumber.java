...
public @interface ValidCreditCardNumber {
  ...
  String message() default "{com.xeline.annotation.validation.constraints.hibernate.ValidCreditCardNumber.message}";
  ...
  /**
   * Defines several {@code ValidCreditCardNumber} annotations on the same element.
   */
  @Target({METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER})
  @Retention(RUNTIME)
  @Documented
  @interface List {
    ValidCreditCardNumber[] value();
  }
