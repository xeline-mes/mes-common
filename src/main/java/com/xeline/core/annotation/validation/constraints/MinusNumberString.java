...
@Retention(RUNTIME)
@ValidPattern(regexp = "^-*[0-9]+$")
@ReportAsSingleViolation
public @interface MinusNumberString {

  String message() default "{com.xeline.annotation.validation.constraints.MinusNumberString.message}";
  ...
  /**
   * Defines several {@code @MinusNumberString} annotations on the same element.
   */
  @Target({METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER})
  @Retention(RUNTIME)
  @Documented
  public @interface List {
    MinusNumberString[] value();
  }
