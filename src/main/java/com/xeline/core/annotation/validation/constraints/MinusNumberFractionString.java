...
public @interface MinusNumberFractionString {

  String message() default "{com.xeline.annotation.validation.constraints.MinusNumberFractionString.message}";
  ...
  /**
   * Defines several {@code @MinusNumberFractionString} annotations on the same element.
   */
  @Target({METHOD, FIELD, ANNOTATION_TYPE, CONSTRUCTOR, PARAMETER})
  @Retention(RUNTIME)
  @Documented
  public @interface List {
    MinusNumberFractionString[] value();
  }
